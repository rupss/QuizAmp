...
public class MyDB {
	...
	//private static final String MYSQL_USERNAME = "ccs108rglobus";
	private static final String MYSQL_USERNAME = "ccs108rupss";
	//private static final String MYSQL_PASSWORD = "thohsiim";
	private static final String MYSQL_PASSWORD = "jeizoosa";
	private static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	//private static final String MYSQL_DATABASE_NAME = "c_cs108_rglobus";
	private static final String MYSQL_DATABASE_NAME = "c_cs108_rupss";
